...
If you discover a security vulnerability in ERM, please report it
...
- **Fix deployed** as soon as a patch is ready, coordinated with
  the reporter
...
Third-party integrations (Discord, MongoDB, GitHub Actions) are
...
- Give us a reasonable amount of time to fix the issue before
  disclosing it publicly
- Make every effort to minimise any disruption caused by the
  disclosure
